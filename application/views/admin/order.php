...
<link rel="stylesheet" type="text/css"
    ...
    <div class="app-content content">
		...
		<form method="post" action="<?= base_url() ?>admin/insert_db">
				...
				<div class="row match-height">
						...
						<input type="hidden"  name="total[]" id="total" class="form-control" placeholder="Total">
													...
													<div class="col-md-6 col-12">
														...
														<button class="btn" style="background: #f2f2f2;"> 
															<a  style="color : #545454;" href="<?php echo base_url('admin/tambah_data'); ?>"> Tambah barang </a> 
														</button>
...
<script>
		function addRow(tableID) {
			...
			$.ajax({
                type  : 'ajax',
                url   : '<?php echo base_url()?>Admin/caricoba',
                async : false,
                dataType : 'json',
                success : function(data){
