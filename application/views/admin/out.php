         ...
         <div class="content-header row">
           ...
           <div class="content-header-right text-md-right col-md-3 col-12">
             <div class="form-group breadcrum-right">
                 ...
                 <div class="dropdown">
                 <div class="container">
                        <form method="post" action="<?= base_url() ?>admin/addissuing">
 ...
 <!--/ Scroll - horizontal and vertical table -->
     ...
     $(document).ready(function() {
         var dataTable = $('#Datainventory').DataTable( {
             ...
             "ajax":{
                 url :"<?php echo site_url('Admin/get_out'); ?>",
                 type: "POST",
                 error: function(){
                     $(".my-grid-error").html("");
  ...
  swal({
    ...
    function(isConfirm) {
      if (isConfirm) {
        swal("Berhasil!", "Data sudah di approve", "success");
        window.location.replace(url);
      } else {
        swal("Tidak jadi", "Data tidak jadi di approve:)", "info");
      }
    });
