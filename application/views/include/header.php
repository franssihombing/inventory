 <?php foreach ($datauser as $key => $userdata) {}?>
     <!-- BEGIN: Header-->
        ...
        <div class="navbar-container content">
          <div class="navbar-collapse" id="navbar-mobile">
            ...
            <ul class="nav navbar-nav float-right">
              <li class="dropdown dropdown-language nav-item"><a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="flag-icon flag-icon-id"></i><span class="selected-language">Indonesia</span></a>
              ...
              <li class="dropdown dropdown-user nav-item">
                <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                  <div class="user-nav d-sm-flex d-none">
                    <span class="user-name text-bold-600"><?php echo $userdata['name']; ?></span>
                    <span class="user-status">Available</span>
                  </div>
                  <span>
                    <img class="round" src="http://inkafuencarral.com/wp-content/uploads/2017/11/avatar_mujer_2.png" alt="avatar" height="40" width="40">
                  </span>
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                  <a class="dropdown-item" href="<?php echo base_url('secure/profile/edit/').$userdata['id_user']; ?>"><i class="feather icon-user"></i> Edit Profile</a>
                  ...
                  <a class="dropdown-item" href="<?php echo base_url('secure/logout'); ?>"><i class="feather icon-power"></i> Logout</a>
                </div>
              </li>
            </ul>
          </div>
