<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>app-assets/vendors/css/tables/datatable/datatables.min.css">
  ...
  <div class="app-content content">
   ...
   <div class="col-12">
         ...
         <!-- <button class="add_cart btn btn-primary"> <a href="<?php echo base_url('admin/tambahvendor'); ?>" style="color : #fff;"> Registrasi Vendor </a> </button> -->
 ...
 <!--/ Scroll - horizontal and vertical table -->
     ...
     $(document).ready(function() {
         var dataTable = $('#Datainventory').DataTable( {
             ...
             "ajax":{
                 url :"<?php echo site_url('Marketing/get_vendor'); ?>",
                 type: "POST",
                 error: function(){
                     $(".my-grid-error").html("");
