         ...
         <div class="content-header row">
           <div class="content-header-left col-md-9 col-12 mb-2">
             <div class="row breadcrumbs-top">
               <div class="col-12">
                 <h2 class="content-header-title float-left mb-0"> Data Merk</h2>
           ...
           <div class="content-header-right text-md-right col-md-3 col-12">
             <div class="form-group breadcrum-right">
                 ...
                 <div class="dropdown">
                 <div class="container">
                        <form method="post" action="<?= base_url() ?>admin/addmerek">
										...
										<div class="form-label-group">
											<select name="id_vendor_barang" class="form-control">
                                                ...
                                                <?php foreach($detail as $d) { ?>
                                                 <option value=" <?php echo $d->id_vendor_barang;?>"> <?php echo $d->nama_vendor;?> </option>  
                                                <?php }; ?>
 ...
 <!--/ Scroll - horizontal and vertical table -->
     ...
     $(document).ready(function() {
         var dataTable = $('#Datainventory').DataTable( {
             ...
             "ajax":{
                 url :"<?php echo site_url('Marketing/get_merek'); ?>",
                 type: "POST",
                 error: function(){
                     $(".my-grid-error").html("");
